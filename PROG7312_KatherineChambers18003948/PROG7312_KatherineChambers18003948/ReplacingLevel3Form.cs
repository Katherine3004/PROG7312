...
{
    public partial class ReplacingLevel3Form : Form
    {
        public ReplacingLevel3Form()
        {
            InitializeComponent();
        }
        ...
        private void ReplacingLevel3Form_Load(object sender, EventArgs e)
        {
            List<Book> library = LibraryManager.getBooks3();
        ...
        private void btnCheck_Click(object sender, EventArgs e)
        {
            ...
            //get answer list
            List<Book> answers3 = LibraryManager.getBookAnswer3();
            //if the lists are equal
            if (bookList.SequenceEqual(answers3))
            {
